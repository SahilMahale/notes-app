        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-center gap-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">Lightning Fast</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-400">⚛️</div>
              <p className="mt-2 text-sm text-slate-400">Powered by React</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-purple-400">🍞</div>
              <p className="mt-2 text-sm text-slate-400">Built with Bun</p>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 pt-6">
            ...
            <div className="space-y-2 text-left">
              <div className="bg-slate-800 rounded p-3 font-mono text-sm">
                <span className="text-slate-500">$</span> <span className="text-amber-400">bun</span> install
              </div>
              <div className="bg-slate-800 rounded p-3 font-mono text-sm">
                <span className="text-slate-500">$</span> <span className="text-amber-400">bun</span> dev
              </div>
            </div>
          </div>
